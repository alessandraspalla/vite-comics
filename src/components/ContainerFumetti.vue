<script>
import AppFumetti from './AppFumetti.vue'
    ...
    data() {
        return {
            products: [
                ...
                {
                    "thumb": "/img/Batman_Beyond.webp",
                    "price": "$2.99",
                    "series": "Batman Beyond",
                    "type": "comic book"
                },
                {
                    "thumb": "/img/Batman_Superman.webp",
                    "price": "$3.99",
                    "series": "Batman/Superman",
                    "type": "comic book"
                },
                {
                    "thumb": "/img/Batman_Superman_Annual.webp",
                    "price": "$4.99",
                    "series": "Batman/Superman Annual",
                    "type": "comic book"
                },
                {
                    "thumb": "/img/Batman_The_Joker_War_Zone.webp",
                    "price": "$5.99",
                    "series": "Batman: The Joker War Zone",
                    "type": "comic book"
                },
                {
                    "thumb": "/img/Batman_Three_Jokers_Collected.webp",
                    "price": "$6.99",
                    "series": "Batman: Three Jokers",
                    "type": "comic book"
                },
                {
                    "thumb": "/img/Batman_White_Knight_Presents_Harley_Quinn.webp",
                    "price": "$4.99",
                    "series": "Batman: White Knight Presents: Harley Quinn",
                    "type": "comic book"
                },
                {
                    "thumb": "/img/Catwoman.webp",
                    "price": "$16.99",
                    "series": "Catwoman",
                    "type": "graphic novel"
                }
...
<template>
    <div class="container">
        <div class="cards">
            <AppFumetti v-for="(product, idx) in products" :key="i" :details="product" />
        </div>
    </div>
</template>
